...
I used XGBoost as the main model because housing prices are highly non-linear and depend on interactions between features like size, rooms, and location. Tree-based models capture these patterns much better than linear models.
...
To capture location, I engineered two features:
- Spatial lag price, which reflects nearby home prices  
- ZIP median price, which captures the overall price level of each area  
